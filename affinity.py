...
if __name__ == '__main__':
    ...
    for line in open(args.inputdir+'PPIAffinity_set.txt'):
       blocks=re.split('\t|\n|    ',line)
       pdbname=blocks[0]
    ...
    for pdbname in complexdict.keys():
        ...
        if pdbname in graph_dict:
            ...
            energy[idx] = 0.0
            data = Data(x=x, edge_index=edge_index,edge_attr=edge_attr,y=y,name=pdbname,energy=energy)
    ...
    i=0
    train_set = featureList
    val_set = test_featureList
